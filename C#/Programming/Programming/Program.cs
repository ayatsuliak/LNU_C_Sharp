...
namespace ConsoleApp1
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            var waterCounters = new List<WaterCounter>() { wc1, wc2, wc3, wc4, wc5 };
            ...
            List<WaterCounter>.Sort(waterCounters, new WatercounterComparer<WaterCounter>());
    ...
    {
        public int Compare(T first, T second) => first.usedWater().CompareTo(second.usedWater());
